...
namespace Common{
	...
	public:
		...
		static void initialize(){
			...
			_consoleAppender = SharedObjectPtr<Appender>(new ConsoleAppender());
			_fileAppender = SharedObjectPtr<Appender>(new DailyRollingFileAppender(
				_T("./log/U游OCX.log"),
			...
			/*
			_consoleAppender->setThreshold(L4CP_DEBUG_LOG_LEVEL);
			_fileAppender->setThreshold(L4CP_INFO_LOG_LEVEL);
			*/
