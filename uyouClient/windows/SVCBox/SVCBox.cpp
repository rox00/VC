// SVCBox.cpp : Implementation of CSVCBoxApp and DLL registration.
...
const GUID CDECL _tlid = { 0xBF7F61E6, 0x2A82, 0x4AEE, { 0xBC, 0x25, 0x4B, 0xF5, 0x5D, 0x92, 0xC4, 0x19 } };
const WORD _wVerMajor = 1;
const WORD _wVerMinor = 0;

CString g_szEXEPath;

// CSVCBoxApp::InitInstance - DLL initialization

BOOL CSVCBoxApp::InitInstance()
{
...
// CSVCBoxApp::ExitInstance - DLL termination

int CSVCBoxApp::ExitInstance()
{
